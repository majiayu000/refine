use super::types::{worst, Indicator, LayerScore, ScoreResult, Signal, DECISION_KEYWORDS};
...
pub(super) fn decision_quality_rate(cluster: &ClusterResult) -> f64 {
...
pub(super) fn depth_output_ratio(stats: &GlobalStats) -> f64 {
...
pub(super) fn layer2(cluster: &ClusterResult, t: &Targets) -> LayerScore {
